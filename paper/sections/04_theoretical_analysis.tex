...
The Aero architecture addresses this variance by approximating the inverse-CDF function $\Phi^{-1}$ through a 1024-entry discrete lookup table $\mathcal{L}$ \cite{devroyeNonUniformRandomVariate1986}.
...
I posit that this space-for-time exchange is justified in modern systems where DRAM capacity is abundant relative to per-core compute throughput.
